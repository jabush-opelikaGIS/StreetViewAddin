...
> The checked-in release archive predates the neutral UI naming in version 1.1. Rebuild the add-in from the current source to receive the updated labels.
...
- `StreetViewAddin/Config.daml`
- `StreetViewAddin/Module1.cs`
- `StreetViewAddin/Buttons/OpenStreetViewTool.cs`
